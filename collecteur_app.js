...
window.addEventListener('online', () => { isOnline = true; toast('📶 Connexion rétablie','ok'); cyclesSynchronisation(); });
...
function goBackFromFiche(){
  // Retour intelligent : vers la tournée ou la recherche selon le contexte
  goTo('tourneeScreen');
}
...
window.addEventListener('load', async () => {
  ...
  setInterval(() => { if (ME) cyclesSynchronisation(); }, 20000);
